...
## Map of Atlanta's Neighborhood Statistical Areas
  Let's divide Atlanta into its Neighborhood Statistical Areas (NSAs), each roughly a square mile:
...
full_data %>%
  ...
  geom_sf_label(data=subset(full_data, full_data$ID == 12), aes(label = 'Downtown', family = "Avenir Next"), size = 2.5) +
  labs(
