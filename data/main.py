    ...
    for nsa in list:
        ...
        for area in areas:
            ...
            try:
                ...
                if "hr" in strtime:
                    inttime += int(strtime[strtime.index("hr") - 1]) * 60
                if "min" in strtime:
                    inttime += int(strtime[strtime.index("min") - 1])
...
if __name__ == '__main__':
    ...
    reset_url = "https://www.google.com/maps/dir/Brookhaven,+GA/Downtown+Atlanta,+Atlanta,+GA/@33.8102996,-84.4006558,13z/data=!3m1!4b1!4m14!4m13!1m5!1m1!1s0x88f5089505f9f565:0x851a6587d0c37ec1!2m2!1d-84.3371266!2d33.8650186!1m5!1m1!1s0x88f5038740415b5d:0xa005d8181c4268d8!2m2!1d-84.3883717!2d33.755711!3e2"
    driver.get(reset_url)
